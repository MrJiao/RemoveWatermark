...
import com.jackson.common.update.net.core.MyRetryTemplate;
...
public abstract class RequestAdapter<T> {
    ...
    public T request(int time,CloseableHttpClient httpClient) {
        return MyRetryTemplate.retryTemplate(time,new MyRetryCallBack(httpClient));
    }
